...
type CaptureSource = "adb" | "window" | "scrcpy" | "ndi" | "capture_card" | "obs";
...
export function LiveCapture() {
  ...
  function startSelectedSource() {
    ...
    if (selectedSource === "capture_card") {
      setError("Capture card input is planned for HDMI/USB devices, but the backend decoder is not connected yet.");
      return;
    }
    ...
    <div className="grid gap-4 xl:grid-cols-[minmax(320px,1fr)_360px]">
      ...
      <aside className="space-y-4">
        ...
        <div className="card p-4">
          ...
          <p className="mt-2 text-sm text-slate-300">Phone ADB, backend scrcpy, NDI, capture card, browser window share, and OBS/camera are separate capture paths. Pick the one that matches the setup.</p>
