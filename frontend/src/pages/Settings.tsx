...
export function Settings(){
  ...
  return <div className="space-y-5">
    ...
    {tab==="General"&&<div className="grid gap-4 md:grid-cols-2"><div className="card p-5"><h3 className="font-bold mb-3">Player Profile</h3><label>Rank Profile<select className="input block mt-2 w-full"><option>Mythic</option><option>Mythical Honor</option><option>Mythical Glory+</option></select></label><label className="block mt-4">Preferred Role<select className="input block mt-2 w-full"><option>Jungle</option><option>Roam</option><option>Mid Lane</option><option>Gold Lane</option><option>Exp Lane</option></select></label></div><div className="card p-5"><h3 className="font-bold mb-3">Comfort Heroes</h3><textarea className="input w-full min-h-32" placeholder="Aamon, Karina, Julian..."/><p className="text-sm text-slate-400 mt-2">These affect recommendation scoring in v0.4.0 draft analysis.</p></div></div>}
